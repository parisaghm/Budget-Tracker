...
export function FinanceDiagnostics({ snapshot }: FinanceDiagnosticsProps) {
  ...
  const rows: Array<{ label: string; value: string }> = [
    ...
    { label: "Income", value: formatMoney(snapshot.incomeCents, snapshot.displayCurrency) },
    { label: "Spent", value: formatMoney(snapshot.spentCents, snapshot.displayCurrency) },
    { label: "Savings", value: formatMoney(snapshot.savingsCents, snapshot.displayCurrency) },
    { label: "Bills due", value: formatMoney(snapshot.billsCents, snapshot.displayCurrency) },
    { label: "Display currency", value: snapshot.displayCurrency },
