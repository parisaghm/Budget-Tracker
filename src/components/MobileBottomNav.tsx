  ...
  return (
    <>
      ...
      <nav
        ...
        className="mobile-bottom-nav fixed inset-x-0 bottom-0 z-40 hidden border-t border-[#E8DFCC] bg-[#FFFDF8]/95 backdrop-blur-md max-[640px]:block"
          ...
          {navItems.map(({ to, label, icon: Icon }) => {
            ...
            return (
              ...
              >
                ...
                {active ? (
                  <span
                    className="absolute bottom-1.5 h-0.5 w-4 rounded-full bg-[#6E4E91]"
                    aria-hidden
                  />
                ) : null}
              </Link>
